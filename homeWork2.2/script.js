...
for (let i = 0; i < simpsons.length; i++) {
    ...
    document.write(`<div class="simpson">
                        ...
                        <img width="200px" src="${simpson.photo}" alt="simpsons">
...
document.write(`<div class="product d-flex">`)
for (let i = 0; i < products.length; i++) {
    let product = products[i];
    document.write(`<div class="product-card">
                            <h3 class="product-title">${product.title} Price - ${product.price}</h3>
                            <img width="200px" height="250px" src="${product.image}" alt="" class="product-image">  
                            <span class="buy d-flex">
                                <button>
                                    Замовити
                                </button>
                            </span>
